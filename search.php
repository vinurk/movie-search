            ...
            <div class="wrapper">
                <div class="searchBar">
                    ...
                    <button id="searchQuerySubmit" name="searchQuerySubmit"
                        onclick="url='http://localhost/movie_search/search.php?q='+document.getElementById('searchQueryInput').value;window.location.href=url">
        ...
        <div id="recommendation_subsection" class="genre_sub_section">
            ...
            <div class="cards_container">
                ...
                try {
                    ...
                    $query = "SELECT * FROM movie_details WHERE LOWER(title) LIKE '%" . $recievedName . "%' LIMIT 10";
                ...
                if (!empty($movies_query_response)) {
                    ...
                    foreach ($movies_query_response as $movie) {
